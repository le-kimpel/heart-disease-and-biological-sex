...
# hypothesis testing -> this is really where the bayesian/frequentist methods shine,
# try to form hypotheses w/ bayesian methods

# now use the technique from the paper
